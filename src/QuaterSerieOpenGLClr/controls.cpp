...
#include <glfw3.h>
/* 
* The "extern" keyword here is to access the variable "window" declared in
* tutorialXXX.cpp. This is a hack to keep the tutorials simple. Please avoid
* this.
*/
...
void computeMatricesFromInputs() 
{
	...
	* It's a bit too complicated for this beginner's tutorial, 
	* so it's disabled instead. 
	*/
	...
	*/
	...
	ViewMatrix = glm::lookAt(
		...
		position + direction, /* and looks here : at the same position, 
							  plus "direction" */
		up					  /* Head is up (set to 0,
...
void computeMatricesFromInputsQuater() 
{
	...
	*/
	...
	up.y = -1;
	up.z = 0;
	//position.z = 5 + val / 1000;
	//position.x = 0 + val / 1000;
	//position.y = 0 + val / 1000;
